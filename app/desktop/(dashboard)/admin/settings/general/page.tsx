...
import { Settings as SettingsIcon, Save, Plus, X, AlertCircle, CheckCircle2, Store, Clock, Users, Timer, Building2, ShieldAlert, Package, Star } from 'lucide-react';
        ...
        <div className="space-y-6 mx-auto">
                ...
                titleChildren={
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-surface-800 hover:bg-surface-900 text-white px-6 py-2.5 rounded-xl font-medium shadow-md transition-colors disabled:opacity-50 focus:ring-4 focus:ring-surface-300 shrink-0"
                        >
                            {saving ? (
            ...
            <div className="bg-white rounded-2xl border border-surface-200 shadow-sm p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <div className="flex items-center gap-2 shrink-0">
                    ...
                    <span className="text-sm font-semibold text-surface-700">Phạm vi cài đặt:</span>
                </div>
                <select
                ...
                {selectedStoreId && (
                    <span className="text-xs bg-accent-50 text-accent-700 px-2 py-1 rounded-lg border border-accent-200 font-semibold whitespace-nowrap">
            ...
            {!selectedStoreId ? (
                <div className="flex flex-col items-center justify-center bg-white rounded-2xl border border-dashed border-surface-300 p-16 text-center mt-6">
                ...
                <>
                    ...
                    {success && (
                        <div className="bg-success-50 text-success-700 p-4 rounded-xl flex items-center gap-3 border border-success-200 animate-in fade-in slide-in-from-top-2 shadow-sm">
                            ...
                            <div className="flex-1 flex items-center justify-between">
                                ...
                                <button
                                    onClick={() => setSuccess('')}
                                    className="text-success-600 hover:text-success-800 text-xs font-semibold px-2 py-1 bg-success-100/50 rounded-md"
                                >
                                    Đóng
                                </button>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        settings?.shiftTimes.map(shift => (
                                            <div key={shift} className="flex items-center justify-between p-3 bg-surface-50 border border-surface-100 rounded-xl group hover:border-accent-200 transition-colors">
                                                ...
                                                <button
                                                    ...
                                                    className="text-surface-400 hover:text-danger-500 hover:bg-danger-50 p-1.5 rounded-lg transition-colors"
                                                >
                                                    <X className="w-4 h-4" />
                                                </button>
                                            </div>
                                            ...
                                            <div key={shift} className="grid grid-cols-2 gap-4 items-center bg-surface-50 p-3 rounded-xl border border-surface-100">
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-white border border-surface-200 text-sm font-bold rounded-lg focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-2"
                                                        placeholder="e.g. 5"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                    ...
                                    <div className="bg-fuchsia-50/50 p-4 rounded-xl border border-fuchsia-100 mb-4 space-y-4">
                                        ...
                                        {newSpecialDate && settings && settings.shiftTimes.length > 0 && (
                                            <div className="space-y-3">
                                                <label className="text-xs font-semibold text-surface-600 block">Thiết lập giới hạn cho ngày này (mặc định theo định mức cuối tuần nếu để trống)</label>
                        ...
                        <div className="bg-white rounded-2xl border border-surface-200 shadow-sm overflow-hidden p-6 transition-all hover:shadow-md">
                            ...
                            <p className="text-sm text-surface-500 mb-6">
                                Tất cả quầy đều dùng để phân công nhân viên. Nút bật/tắt chỉ kiểm soát chức năng kho của từng quầy.
                            </p>
                            ...
                            <div className="space-y-2 overflow-y-auto pr-2">
                                {counters.length === 0 ? (
                                    ...
                                    counters.map(counter => (
                                        <div key={counter.id} className="flex items-center justify-between p-3 border rounded-xl group transition-colors bg-surface-50 border-surface-100 hover:border-warning-200">
