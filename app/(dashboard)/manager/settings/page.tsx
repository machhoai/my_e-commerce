                            ...
                            <div className="bg-orange-50/50 p-4 rounded-xl border border-orange-100 space-y-4">
                                <div className="space-y-1.5 pb-3 border-b border-orange-200/50">
                                    ...
                                    <input type="number" min="0" max="31"
                                        ...
                                        className="w-full sm:w-1/2 bg-white border border-surface-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 4"
                                    />
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="0"
                                                ...
                                                className="w-full bg-white border border-surface-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 10"
                                            />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="1"
                                                ...
                                                className="w-full bg-white border border-surface-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 25"
                                            />
                                        </div>
                                    </div>
                                </div>
