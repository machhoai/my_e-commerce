    ...
    return (
        <div className="space-y-6 mx-auto">
            ...
            {success && (
                <div className="bg-emerald-50 text-emerald-700 p-4 rounded-xl flex items-center gap-3 border border-emerald-200 animate-in fade-in slide-in-from-top-2 shadow-sm">
                    ...
                    <div className="flex-1 flex items-center justify-between">
                        ...
                        <button onClick={() => setSuccess('')} className="text-emerald-600 hover:text-emerald-800 text-xs font-semibold px-2 py-1 bg-emerald-100/50 rounded-md">
                            Đóng
                        </button>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {settings?.shiftTimes.length === 0 ? (
                                ...
                                settings?.shiftTimes.map(shift => (
                                    <div key={shift} className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl group hover:border-indigo-200 transition-colors">
                                        ...
                                        <button onClick={() => handleRemoveShift(shift)} className="text-slate-400 hover:text-red-500 hover:bg-red-50 p-1.5 rounded-lg transition-colors">
                                            <X className="w-4 h-4" />
                                        </button>
                                    </div>
                                ))
                                    ...
                                    <div key={shift} className="grid grid-cols-2 gap-4 items-center bg-slate-50 p-3 rounded-xl border border-slate-100">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="1"
                                                ...
                                                className="w-full bg-white border border-slate-200 text-sm font-bold rounded-lg focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-2" placeholder="e.g. 5"
                                            />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="1"
                                                ...
                                                className="w-full bg-white border border-slate-200 text-sm font-bold rounded-lg focus:ring-fuchsia-500 focus:border-fuchsia-500 block p-2" placeholder="e.g. 8"
                                            />
                                        </div>
                                    </div>
                                ))
                            ...
                            <div className="bg-orange-50/50 p-4 rounded-xl border border-orange-100 space-y-4">
                                <div className="space-y-1.5 pb-3 border-b border-orange-200/50">
                                    ...
                                    <input type="number" min="0" max="31"
                                        ...
                                        className="w-full sm:w-1/2 bg-white border border-slate-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 4"
                                    />
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="0"
                                                ...
                                                className="w-full bg-white border border-slate-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 10"
                                            />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" min="1"
                                                ...
                                                className="w-full bg-white border border-slate-200 text-sm font-bold rounded-lg focus:ring-orange-500 focus:border-orange-500 block p-2" placeholder="VD: 25"
                                            />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-fuchsia-50/50 p-4 rounded-xl border border-fuchsia-100 mb-4 space-y-4">
                                ...
                                {newSpecialDate && settings && settings.shiftTimes.length > 0 && (
                                    <div className="space-y-3">
                                        <label className="text-xs font-semibold text-slate-600 block">Thiết lập giới hạn cho ngày này</label>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-6 transition-all hover:shadow-md h-fit">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-bold text-slate-800 flex items-center gap-2">
